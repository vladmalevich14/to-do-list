...
test('correct task should be deleted from correct array', () => {
    ...
    const action = removeTaskTC.fulfilled(args, 'requestId', args);
...
test('correct task should be added to correct array', () => {
    ...
    const action = addTaskTC.fulfilled(args, 'requestId', {title: "juce", todolistId: "todolistId2"});
...
test('status of specified task should be changed', () => {
    ...
    const action = updateTaskTC.fulfilled(args, 'requestId', args);
...
test('title of specified task should be changed', () => {
    const args = {taskId: "2", model: {title: "yogurt"}, todolistId: "todolistId2"}
    const action = updateTaskTC.fulfilled(args, 'requestId', args);
