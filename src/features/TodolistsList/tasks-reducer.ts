...
export const changeTaskEntityStatusAC = (todolistId: string, id: string, entityStatus: RequestStatusType) =>
    ({type: 'CHANGE-ENTITY-TASK-STATUS', todolistId, id, entityStatus} as const)
...
export const removeTaskTC = (taskId: string, todolistId: string) => (dispatch: DispatchType) => {
    dispatch(setAppStatusAC('loading'))
...
export const addTaskTC = (title: string, todolistId: string) => (dispatch: DispatchType) => {
    dispatch(setAppStatusAC('loading'))
