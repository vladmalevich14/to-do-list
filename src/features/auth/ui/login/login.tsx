                  ...
                  here
                        ...
                        <FormGroup>
                            ...
                            <div className={s.attention}>
                                <h2>ATTENTION!</h2>
                                If you currently can't sign in to Google Chrome, use a another browser. Third-party browser
                                cookies don't work for everyone. Google is gradually disabling them.
                            </div>
                        </FormGroup>
                    </FormControl>
                </form>
